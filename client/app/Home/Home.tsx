...
import DropdownModal from "@/app/components/DropdownModal/DropdownModal";
...
type DropdownType = "color" | "price" | "brand" | null;
...
export default function Home() {
  ...
  const [dropdownOrigin, setDropdownOrigin] = useState<DropdownOrigin | null>(
    null
  );

  const handleDropdownOpen = (type: DropdownType, e: React.MouseEvent) => {
    ...
    <div className="flex flex-col min-h-screen bg-[#111827]">
      ...
      <main className="flex-1 bg-[#1F2937]">
        ...
        {openDropdown === "color" && (
          <DropdownModal
            items={colorOptions}
            origin={dropdownOrigin || undefined}
        ...
        {openDropdown === "price" && (
          <DropdownModal
            ...
            onSelect={(label) => {
              ...
              if (opt) setSelectedPrice(opt.value);
            }}
            onClose={() => setOpenDropdown(null)}
          />
        )}
